...
namespace tools
{
  ...
  inline Color Color::hsv(byte h, byte s, byte v, byte a)
  {
  ...
  {
    return static_cast<byte>(std::floor(getf(i) * 255 + 0.5f));
  }
  ...
  inline byte  Color::h()  const { return getf(H) + 0.5; }
  ...
  inline void Color::set_h(byte i)   { *this = hsv (   i,  s(),  v(),  a()); }
